...
namespace CalculoAplicación.Figuras
{
    class _3d
    {
        private int x;
        ...
        public void CirculoLleno(int Cx1, int Cy1, int TamH, int TamV, Graphics g, Brush p)
        {
            Rectangle Rect = new Rectangle(Cx1, Cy1, TamH, TamV);
        ...
        public void CilindroLleno(int Cx1, int Cx2, int Cx3, int Cy1, int Cy2, int Cy3, Graphics g, Pen p, Brush b)
        {
            int My = Cy3 / 10;
            Rectangle Rect = new Rectangle(Cx1, Cy1, Cx2, Cy3 / 5);
            Rectangle Rect2 = new Rectangle(Cx1, Cy3, Cx2, Cy3 / 5);
